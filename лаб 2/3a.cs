...
namespace _3a
{
    class Program
    {
        ...
        static void Evaluate(float First, float Second)
        {
            ...
            Console.WriteLine("додаємо {0} (a), до {1} (b)", First, Second);
            ...
            Console.WriteLine("  перетворимо \"a\" в двійкову :\n\t{0}",
                ResultToBinaryString(a_sign_bit, 0, a_float_bits));
            Console.WriteLine("  перетворимо \"b\" в двійкову :\n\t{0}",
